...
\begin{itemize}
	...
	\item RegisterDate (Data de quando foi feito o registro do usuário)
...
A aplicação escolhida foi o Celery, ela gera filas de execução de tarefas por meio de troca de mensagens. A grande vantagem dessa escolha é a facilidade de configuração que o Celery tem com Django, e a vasta documentação existente para configuração de suas funcionalidades.?????? DEU RUIM O DJANGO hehe FALAR DO REDIS.
